                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: 5.0),
                                          Text(
                                            'Preparation Time: ${_selectedServings * widget.recipe.prepTime} dk',
                          ...
                          children: [
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    Text('Ingredients', style: TextStyle(color: _selectedIndex == 0 ? Colors.white : Colors.black)),
                                  ],
                                ),
                              ),
                            ),
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    Text('Instructions', style: TextStyle(color: _selectedIndex == 1 ? Colors.white : Colors.black)),
                                  ],
                                ),
                              ),
                            ),
